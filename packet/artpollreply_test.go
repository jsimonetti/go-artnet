...
func TestArtPollReplyPacketMarshal(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			b: []byte{
				0x41, 0x72, 0x74, 0x2d, 0x4e, 0x65, 0x74, 0x00, 0x00, 0x21, 0x00, 0x00, 0x00, 0x00, 0x19, 0x36,
		...
		},
		{
			...
			b: []byte{
				0x41, 0x72, 0x74, 0x2d, 0x4e, 0x65, 0x74, 0x00, 0x00, 0x21, 0x0a, 0x01, 0x01, 0x01, 0x19, 0x36,
